...
/**
 * Side sheets use `w-(--sheet-side-width,20rem)` so callers can widen via a CSS
 * variable instead of overriding `data-[side=*]` width utilities. Example:
 * `className="[--sheet-side-width:42rem]"` or `[--sheet-side-width:min(42rem,calc(100vw-2rem))]`.
 */
