...
function FieldContent({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn("group/field-content flex flex-1 flex-col gap-micro leading-snug", className)}
      {...props}
    />
  );
}
...
function FieldDescription({ className, ...props }: React.ComponentProps<"p">) {
  return (
    <p
      ...
      className={cn(
        "text-left text-sm leading-normal font-normal normal-case tracking-normal text-muted-foreground group-has-data-horizontal/field:text-balance [[data-variant=legend]+&]:-mt-1.5",
...
function FieldError({
  ...
  const content = useMemo(() => {
    ...
    return (
      <ul className="ml-section flex list-disc flex-col gap-micro">
