...
function DataTable<TData, TValue>({ columns, data, className }: DataTableProps<TData, TValue>) {
...
// Re-export tanstack types so consumers never import "@tanstack/react-table" directly
export {
  flexRender,
  getCoreRowModel,
  getFilteredRowModel,
