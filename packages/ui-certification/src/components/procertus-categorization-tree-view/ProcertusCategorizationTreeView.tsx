 ...
 * Pass a {@link ProcertusCategorizationDoc} from the app (e.g. context or default import from `@procertus-ui/ui-certification`).
 */
import {
...
export type { CertificationLabelKey } from "../../types";
