 ...
 *   innovation-attest en metrologie zijn vervangen door compacte secties met
 *   thin border, zodat de hele pagina in één oogopslag scanbaar blijft.
 * - De ChoiceCardGroup (multi-select drafts om mee in te dienen) is een
 *   compacte tabel met inline checkbox-cellen.
 * - Knop "Aanvragen wijzigen" is weg — gebruiker navigeert terug via "Terug"
 *   of via de klikbare stepper.
 */
import {
  Badge,
  Checkbox,
...
export type OnboardingSummaryStepProps = {
  ...
  return (
    <div className="flex w-full min-w-0 flex-col gap-6">
          ...
          >
            ...
            <TableBody>
              {allDraftsForChecklist.map((draft) => {
                ...
                const id = `summary-include-${draft.id}`;
                return (
      ...
      {submissionNoteUnlocked ? (
        ...
        >
          <H3 id="summary-submission-note-heading" className="m-0">
