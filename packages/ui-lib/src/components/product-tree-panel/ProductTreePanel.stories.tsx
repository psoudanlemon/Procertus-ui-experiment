...
const meta = {
  title: "Request Management/ProductTreePanel",
  ...
  parameters: {
    ...
    docs: {
      description: {
        component:
          "Procertus **decision-tree** drilldown surface: `group` nodes are collapsible; `product` rows call `onSelectProduct`. Expandsion is **controlled** via `expandedIds` and `onToggle` (use `set` from React or Immer in the app).",
      },
    },
  },
  tags: ["autodocs"],
  ...
  return (
    <div className="max-w-5xl space-y-2">
      <ProductTreePanel
        ...
        description="Reference fixture — 3 product rows under nested groups. Filter demo clears the tree on a long query (story-only)."
        searchValue={q}
        onSearchChange={setQ}
        nodes={emptyTree}
