...
export type ExtranetUser = {
  name?: string;
  email: string;
  avatar?: string;
};

export type ExtranetHeaderProps = {
...
function getInitials(user: ExtranetUser): string {
  if (user.name) {
...
function ExtranetHeader({
  ...
  return (
    ...
    >
      ...
      <style>{`
        [data-slot="extranet-header"] [data-slot="sheet-overlay"] {
