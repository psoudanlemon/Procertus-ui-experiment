...
import { ExtranetAppShell } from "./ExtranetAppShell";
...
/**
 * The extranet application shell for Procertus — a search-first portal
 ...
 */
const meta = {
  title: "Extranet/Application Shell",
  component: ExtranetAppShell,
  tags: ["autodocs"],
  parameters: {
    layout: "fullscreen",
    docs: {
...
} satisfies Meta<typeof ExtranetAppShell> as Meta<typeof ExtranetAppShell>;
